...
\title{Scientific Article Classification and Semantic\\
Recommendation Using Transformer-Based Models:\\
A Study on the arXiv Dataset}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/fig4_pipeline_diagram.pdf}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/fig5_training_curves.pdf}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/fig6_confusion_matrix.pdf}
...
\begin{figure*}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/fig7_per_class_metrics.pdf}
